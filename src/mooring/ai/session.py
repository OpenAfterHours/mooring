...
_TOOL_GUIDE = (
    ...
    "cell's code. Take the index from the cell view you were given, but that view is a "
    "snapshot: once anything has been applied this session, call "
    "mooring_read_notebook_source first, because inserting or deleting a cell renumbers "
    "the ones after it and a stale index edits the WRONG cell\n"
