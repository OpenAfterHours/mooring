...
_TOOL_GUIDE = (
    ...
    "real cell and refuses the whole change if they disagree — that is what stops a stale "
    "index writing over a cell you never read, so send what you actually saw, never a "
    "guess. Take indices from the cell view you were given, but that view is a SNAPSHOT: "
